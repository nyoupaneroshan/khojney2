...
export default function AnalyticsPage() {
        ...
        try {
            ...
            const fetchDataForPeriod = async (range: { from: Date, to: Date }, isMainPeriod: boolean) => {
                ...
                const [
                    ...
                    attemptsQuery,
                    // Signups query fetches profiles created within the period for the 'New Users' KPI
            ...
            setData({
                kpis: { totalQuizzes, avgScore: parseFloat(avgScore.toFixed(1)), topCategory: categoryChartData[0]?.name || 'N/A', totalUsers: currentPeriodNewUsers },
                kpiChanges: {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (profile?.role === 'admin') {
                        ...
                        // 4. Fetch initial analytics data
    ...
    const handleFilterChange = () => {
        // Ensure date is valid before updating URL and fetching data
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 items-center">
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button id="date" variant={"outline"} className="w-full sm:w-[280px] justify-start text-left font-normal bg-gray-800 border border-gray-600 hover:bg-gray-700 hover:text-white">
                ...
                {isFiltering ? (
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="space-y-8">
                        ...
                        <div className="grid grid-cols-12 gap-6">
                            {/* --- Daily Activity Chart (Uses combinedChartData) --- */}
